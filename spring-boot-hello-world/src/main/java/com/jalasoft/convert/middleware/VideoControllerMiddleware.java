...
public class VideoControllerMiddleware implements Filter {
     ...
     * in this case this is the filter for VideoController
     */
    @Override
    public void doFilter(ServletRequest request,
        ...
        try {
            ...
            throw new RuntimeException("Number of token uses exhausted, Please request another Token to keep using the service", e.getCause());
        }
    }
}
